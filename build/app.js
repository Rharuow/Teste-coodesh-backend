...
var getDataFromSpaceXAPI_1 = require("./utils/getDataFromSpaceXAPI");
var routes_1 = require("./routes/routes");
var seed_1 = require("./utils/seed");
var swaggerDef_1 = require("./swaggerDef");
...
app.use("/docs", swagger_ui_express_1.default.serve, swagger_ui_express_1.default.setup(swaggerDef_1.swaggerDef));
app.use("/", routes_1.router);
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var launches, error_1;
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, (0, getDataFromSpaceXAPI_1.getDataFromSpaceX)()];
                            case 1:
                                status = _a.sent();
                                console.log(status);
                                return [2 /*return*/];
