...
var seed = function () { return __awaiter(void 0, void 0, void 0, function () {
    var launchesMongo, launches, rockets, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                launches = (_a.sent());
                rockets = launches.reduce(function (rckts, current) {
                ...
                return [4 /*yield*/, Launch_1.LaunchModel.insertMany(launches)];
            case 4:
                _a.sent();
                return [4 /*yield*/, Rocket_1.RocketModel.insertMany(rockets)];
            case 5:
                _a.sent();
