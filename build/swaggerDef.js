...
exports.swaggerDef = {
    ...
    info: {
        ...
        description: "In this project, the SpaceX API (https://github.com/r-spacex/SpaceX-API) provides info about rocket's launches made by company. When the server is started, a script get this informations and save at mongoDB handled for this project. Furtermore, a CRON call a funcation at 9:00 am, every day, to get the latest launch, and update at mongoDB. In this project there'r four routes, list launches with pagination and search by name rocket, home that's just apresentation, stats to pice graphic and stats to vertical bar graphic.",
        contact: {
    ...
    paths: {
        ...
        "/launches": {
            get: {
                ...
                description: "Return all launches and accept query param router 'search' thats filter launches by name porperty. Futermore, 'limit' and 'page' can be pass at query param router to paginate the request. All the params are optionals",
                tags: ["Launch"],
                parameters: [
                    {
                        name: "search",
        ...
        "/stats/pie": {
            get: {
                ...
                responses: {
                    ...
                    "400": {
                        description: "Sorry, there was an error generating the rocket pizza statistics",
                    },
                },
            },
        },
        "/stats/bar": {
            get: {
                ...
                responses: {
                    ...
                    "400": {
                        description: "Sorry, there was an error generating the rocket bar stats",
                    },
                },
            },
        },
